...
def getTopOfWeek():
    ...
    for post in JSON:
        try:data = (e621Post(id=post['id'],tags=post['tags'],description=post['description'],created_at=post['created_at'],creator_id=post['creator_id'],author=post['author'],source=post['sources'],score=post['score'],fav_count=post['fav_count'],md5=post['md5'],file_size=post['file_size'],file_url=post['file_url'],file_ext=post['file_ext'],preview_url=post['preview_url'],preview_width=post['preview_width'],preview_height=post['preview_height'],sample_url=post['sample_url'],sample_width=post['sample_width'],sample_height=post['sample_height'],rating=post['rating'],status=post['status'],width=post['width'],height=post['height'],has_notes=post['has_notes'],has_children=post['has_children'],children=post['children'],parent_id=post['parent_id'],artist=post['artist']))
        except KeyError:data = (e621Post(id=post['id'],tags=post['tags'],description=post['description'],created_at=post['created_at'],creator_id=post['creator_id'],author=post['author'],source=post['source'],score=post['score'],fav_count=post['fav_count'],md5=post['md5'],file_size=post['file_size'],file_url=post['file_url'],file_ext=post['file_ext'],preview_url=post['preview_url'],preview_width=post['preview_width'],preview_height=post['preview_height'],sample_url=post['sample_url'],sample_width=post['sample_width'],sample_height=post['sample_height'],rating=post['rating'],status=post['status'],width=post['width'],height=post['height'],has_notes=post['has_notes'],has_children=post['has_children'],children=post['children'],parent_id=post['parent_id'],artist=post['artist']))
        posts.append(data)
    return posts
